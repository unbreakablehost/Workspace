...
public class atm {
	...
	//The program takes an input amount from the user and calculates the number of currency notes (in denominations of 2000, 500, and 100) required to represent that amount.
//	in notesOf = [2000, 500, 100]
